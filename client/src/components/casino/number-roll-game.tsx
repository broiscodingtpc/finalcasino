          ...
          <div className="mb-8">
            ...
            <div className="flex justify-center space-x-4 mb-4">
              <Input
                ...
                disabled={isRolling}
              />
              <span className="flex items-center text-gray-400">$JOKER</span>
            </div>
                ...
                <div className="text-center">
                  ...
                  {gameResult.won && (
                    <p className="text-lg mt-2 text-green-400">
                      +{gameResult.payout.toLocaleString()} $JOKER
                    </p>
                  )}
                  {!gameResult.won && (
                    <p className="text-lg mt-2 text-red-400">
                      -{betAmount.toLocaleString()} $JOKER
                    </p>
                  )}
                  <Button
                    onClick={resetGame}
